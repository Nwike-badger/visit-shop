export const NIGERIA_STATES = {
  "Abia": [
    ...
    "Ukwa East", "Ukwa West", "Umu Nneochi",
  ...
  "Benue": [
    ...
    "Gwer East", "Gwer West", "Katsina Ala",
    "Konshisha", "Kwande", "Logo", "Makurdi", "Obi",
    "Ogbadibo", "Ohimini", "Oju", "Okpokwu",
  ...
  "Kano": [
    ...
    "Fagge", "Gabasawa", "Garko",
    "Garun Mallam", "Gaya", "Gezawa",
    "Gwale", "Gwarzo", "Kabo",
  ...
  "Katsina": [
    ...
    "Bindawa", "Charanchi", "Dan Musa",
    "Dandume", "Danja", "Daura",
    "Dutsi", "Dutsin Ma", "Faskari",
    "Funtua", "Ingawa", "Jibia",
    "Kafur", "Kaita", "Kankara",
    "Kankia", "Katsina", "Kurfi",
  ...
  "Kogi": [
    ...
    "Dekina", "Ibaji", "Idah",
    "Igalamela Odolu", "Ijumu",
    "Kabba Bunu", "Kogi Koton Karfe",
  ...
  "Niger": [
    ...
    "Munya", "Paikoro", "Rafi", "Rijau",
    "Shiroro", "Suleja", "Tafa", "Wushishi"
  ],
  "Ogun": [
    "Abeokuta North", "Abeokuta South", "Ado Odo Ota",
    "Ewekoro", "Ifo", "Ijebu East", "Ijebu North",
    "Ijebu North East", "Ijebu Ode", "Ikenne",
    "Imeko Afon", "Ipokia", "Obafemi Owode",
    "Odeda", "Odogbolu", "Ogun Waterside",
  ...
  "Osun": [
    ...
    "Ifedayo", "Ifelodun", "Ila", "Ilesa East",
    "Ilesa West", "Irepodun", "Irewole", "Isokan",
    "Iwo", "Obokun", "Odo Otin", "Ola Oluwa",
  ...
  "Oyo": [
    ...
    "Kajola", "Lagelu", "Ogbomosho North",
    "Ogbomosho South", "Ogo Oluwa", "Olorunsogo",
  ...
  "Yobe": [
    ...
    "Karasuwa", "Machina", "Nangere", "Nguru",
